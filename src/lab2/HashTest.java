...
class HashTest {
	...
	private void testRandomInput() {
		...
		final int[] capacities = {10000};
		final int[] inputSizes = {2500, 5000, 7500, 10000, 12000};
		...
		for (int capacity : capacities) {
			for (int inputSize : inputSizes) {
				...
				for (int i = 0; i < tests; i++) {
					...
					final int[] inputs = arraysGenerator.randomUnique(inputSize);
					HashTableVariant hashTableVariant = new HashTableVariant(capacity);
					LinearHash linearHash = new LinearHash(capacity);
				...
				System.out.println("No. input values:............... " + inputSize);
